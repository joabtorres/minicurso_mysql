...
-- Atualizir a categoria do AÇAI E TOMATE para  Alimentício;
UPDATE produtos SET cod_categoria='1' WHERE cod = '100023';
UPDATE produtos SET cod_categoria='1' WHERE cod = '100022';

-- Atualizir a quantidade de tomate para 50 --
UPDATE produtos SET quantidade = '30' WHERE cod = '100022';

-- Atualizir o valor de venda para 9.50 e valor de receita para 275 do tomate--
UPDATE produtos SET valor_venda='9.5', valor_receita='275' WHERE cod='100022';
